...
class Broker:
    ...
    def _can_open(self, order: Order, cost: float) -> bool:
        # TODO: implement margin/short mechanics properly
        if cost > self._cash:
            warnings.warn("Insufficient cash, skipping order. Results may be imprecise.")
            return False
        return True
